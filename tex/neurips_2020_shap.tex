...
Whether to use conditional or causal Shapley values depends on interpretation: what happens if we set the features to their values compared to what happens to when we observe that features obtain their values. Both interpretations are fine, but the latter enables us to leverage additional available information regarding the causal structure.
